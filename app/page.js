...
export default function Home() {
  ...
  const getExpenditureRecords = async () => {
    try {
      ...
      console.table([res]);
      console.table(totalLendingList);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <div className="bg-black mt-2 text-white h-[100vh]">
      ...
      {lendingRecords && (
        <div className=" bg-black text-white mx-auto max-w-7xl pt-40 px-6" id="exchange-section">
